...
//#3
// dogs.map((dog) => {
//   const goodRangeAbove = dog.recommendedFood + (dog.recommendedFood * 0.1);
//   const goodRangeBelow = dog.recommendedFood - (dog.recommendedFood * 0.1);
//   if (dog.curFood < goodRangeBelow ) {
//     ownersEatTooLittle.push(dog.owners)
//   } else if (dog.curFood > goodRangeAbove) {
//     ownersEatTooMuch.push(dog.owners)
//   } else{
//     ownersEatWell.push(dog.owners) //#7
//   }
// })

// console.log(ownersEatTooLittle);
// console.log(ownersEatTooMuch);
// console.log(ownersEatWell);

// //#5
// const dogsFilterExactly = dogs.some(dog => dog.curFood = dog.recommendedFood)
// console.log(dogsFilterExactly); //true

// //#6
// const dogFilterOkay = dogs.some(
//   (dog) =>
//     (dog.curFood =
//       dog.recommendedFood - dog.recommendedFood * 0.1 ||
//       dog.recommendedFood - dog.recommendedFood * 0.1)
// );
// console.log(dogFilterOkay); //true

// //#8
// const filteredNewRecommend = dogs.map(dog => dog.recommendedFood).sort((a, b) => a-b)
